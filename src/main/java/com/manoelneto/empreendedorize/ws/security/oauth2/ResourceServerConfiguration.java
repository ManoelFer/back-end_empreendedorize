...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    @Override public void configure(HttpSecurity http) throws Exception {
        http.
                ...
                .antMatchers("/api/capitalSocial/**").hasAnyRole("ADMIN", "USER")
                .antMatchers("/api/dadosEmpreendedores/**").hasAnyRole("ADMIN", "USER")
                .antMatchers("/api/fonteDeRecursos/**").hasAnyRole("ADMIN", "USER")
                .antMatchers("/api/missaoDaEmpresa/**").hasAnyRole("ADMIN", "USER")
                .antMatchers("/api/setoresDeAtividade/**").hasAnyRole("ADMIN", "USER")
                .antMatchers("/api/analiseDoPlano/**").hasAnyRole("ADMIN", "USER")
                .anyRequest().denyAll()
                .and()
                .exceptionHandling()
