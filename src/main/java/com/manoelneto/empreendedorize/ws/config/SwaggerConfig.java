...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.manoelneto.empreendedorize.ws.resources"))
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfo(
                "API do meu TCC empreendedorize",
                "Esta API é utilizada no site empreendedorize",
                "Versão 1.0",
    ...
    @Bean public SecurityConfiguration securityInfo() {
